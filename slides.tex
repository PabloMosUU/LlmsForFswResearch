...
\begin{frame}{Today's Agenda}
    \begin{itemize}
        ...
        \item AI, ML, and LLMs (10 min)
        \item Model Learning Process (5 min)
        \item Generative AI (5 min)
        \item Limitations and Risks (10 min)
        \item Free vs. Paid Systems (5 min)
        \item LLM Use in \kp\ Research (10 min)
...
\begin{itemize}
\item    \textbf{Activity: Think-Pair-Share} (5 min)
    
    \item \textbf{Prompt}: What do you currently know about Large Language Models (LLMs)?
    
    \item \textbf{Instructions}: 
    \begin{itemize}
        \item Think individually
        \item Pair up to share thoughts 
        \item Share with the class
    \end{itemize}
  
    \item \textbf{Goal}: Assess prior knowledge and create baseline understanding
    \end{itemize}
\end{frame}
